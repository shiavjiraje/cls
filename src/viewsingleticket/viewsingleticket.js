...
//import { vendorAction } from '../_actions/ViewSingleTicket';
...
const ViewSingleTicket = () => {
 ...
 const url ='http://www.apiats.somee.com/api/';
    ...
    const getAllTickets=()=>{
        axios.get(`${url}clsreplyticket?email=ajay.zala@archesoftronix.com&ticketno=20210224001`)
        ...
        <React.Fragment>
            <Navbarsupoort activeTickitThread={activeTickitThread}/>
                 ...
                 <div className="content pt-5">
                       <Row>
                            <Col lg={12}>
                               <h6 className="text-span"><b>Ticket Number : {viewticketdetails.ticketno}</b></h6>
                           </Col>
                           <Col lg={6} >
                               <div className="dark-section p-3">
                               <h6 className="text-span"><b>Basic Ticket Information</b></h6>
                               <label>Ticket Status : {viewticketdetails.initialstatus}</label><br/>
                               <label>Deapartment : {viewticketdetails.business}</label><br/>
                           ...
                           <h6 className="text-span"><b>User Information</b></h6>
                               <label>Name : {viewticketdetails.name}</label><br/>
                               <label>Email : {viewticketdetails.email}</label><br/>
                           ...
                           <Row>
                                ...
                                <Col lg={11}>
                                <div class="card">
                                <div class="card-header bgprimary">{viewticketdetails.number} Posted {viewticketdetails.createdate}</div>
                                <div class="card-body">Content</div>
                                </div>
                                <Col lg={12} className="mt-3">
                                    <i class="fa fa-pencil-square-o text-span font-18" aria-hidden="true"></i><label className="createdby"> Created By</label>
                                    <i class="fa fa-user-o text-span font-18 ml-5" aria-hidden="true"></i><label className="ml-2">{viewticketdetails.phoneno}</label>
                                    <label className="createdby ml-2"> {viewticketdetails.createdate}</label>
                                </Col>
                                </Col>
                                </Row>
                                <Row>
                                ...
                                <Col lg={12} className="mt-3">
                                   <label className="createdby"> Closed By</label>
                                    <label className="ml-2">{viewticketdetails.name}</label>With Status of
                                    <label className="createdby ml-2"> {viewticketdetails.initial_status}</label>
                                    <label className="createdby ml-2"> {viewticketdetails.finaldate}</label>
                           ...
                           <div className="dark-section p-3 blue-brd">
                               ...
                               <label className="mt-2">To best assist you, we request that you be specific and detailed</label>
                                ...
                                <Col lg={12} className="mt-4 text-center">
                                    ...
                                    <button type="button"  className="btn btn-primary ml-2">Cancel</button> 
                                </Col>
                           </div>
                           </Col>
                       </Row>

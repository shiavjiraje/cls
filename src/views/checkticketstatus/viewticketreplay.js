...
var urlpattern =config.baseUrl;
 ...
 // const urlreplay =urlpattern;
   ...
   // replays.replies.forEach(element => console.log(element));
    var ticketreplay =props.viewticketdetails.replies || [];
    ...
    return (
        ...
        <div className="content pt-5">
              <Row>
                   <Col lg={12}>
                      <h6 className="text-span"><b>Ticket Number : {props.viewticketdetails.ticketno}</b></h6>
                  </Col>
                  <Col lg={6} >
                      <div className="dark-section p-3">
                      <h6 className="text-span"><b>Basic Ticket Information</b></h6>
                      <label>Ticket Status : {props.viewticketdetails.initialstatus}</label><br/>
                      <label>Deapartment : {props.viewticketdetails.business}</label><br/>
                      <label>Create Date : {props.viewticketdetails.createdate}</label>
                      </div>
                  </Col>
                  <Col lg={6}>
                  <div className="dark-section p-3">
                  <h6 className="text-span"><b>User Information</b></h6>
                      <label>Name : {props.viewticketdetails.name}</label><br/>
                      <label>Email : {props.viewticketdetails.email}</label><br/>
                      <label>Phone : {props.viewticketdetails.phoneno}</label>
                      </div>
                  </Col>

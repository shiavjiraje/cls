                  ...
                  <div className="form-group form-check">
                    <label className="form-check-label">
                      ...
                      defaultChecked={false} onChange={(e) => {
                                            setagree (e.target.value); console.log(e.target.value)
...
<div>If you are a Non-Third party please read Note 4 and confirm you agree to provide the Anti-Money Laundering documentation in Note 4</div></label>
                ...
                <Row className="mt-4">
                  <Col lg={9}>
                  <label><h6><b>Incorporation Type: <span className="redspan">*</span></b> </h6><div className="text-span"> Note 4 </div></label>
                  </Col>
                  <Col lg={3}>                  
                  <div className="form-group">
                  <select className="form-control"  ref={register({ required: true })} onChange={(e) => {
                ...
                <Row className="mt-3">
                  <Col lg={9}>
                  <label><h6><b>Company Pack Type (Select) <span className="redspan">*</span></b> </h6><div className="text-span"> Note 6 </div></label>
                  </Col>
                  <Col lg={3}>                  
                  <div className="form-group">
                  <select className="form-control"  ref={register({ required: true })} onChange={(e) => {
                    ...
                    <option value="">Select</option>
                    <option value="Basic Pack (Digital)">Basic Pack (Digital)</option>
                ...
                <Row className="mt-3">
                  <Col lg={9}>
                  <label><h6><b>Payment Type (Select)<span className="redspan">*</span></b> </h6></label>
                  </Col>
                  <Col lg={3}>                  
                  <div className="form-group">
                  <select className="form-control"  ref={register({ required: true })} onChange={(e) => {
                ...
                <Row className="mt-4">
                  <Col lg={3}>
                    <label>Practice/Company Name<span className="redspan">*</span></label>
                  </Col>
                  <Col lg={3}>
                    <input type="text"  ref={register({ required: true })} className="form-control" onChange={(e) => {
                ...
                <Row className="mt-4">
                  <Col lg={3}>
                    <label>Phone Number<span className="redspan">*</span></label>
                  </Col>
                  <Col lg={3}>
                ...
                <Row className="pb-3">
                  ...
                  <Col lg={6} className="text-right">
                    <button type="button" className="btn btn-primary" onClick={props.onSecondSectionClick}>Next</button> 
                  </Col>
                </Row>
                </form>
              </div>
